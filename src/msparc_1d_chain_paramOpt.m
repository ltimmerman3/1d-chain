function S = msparc_1d_chain(r1, box_size, Z_in, sigma_in, kappa, epsilon, n_atm, XC)
if strcmpi(XC,'None')
...
Z = Z_in*ones(size(Atoms));
b_sigma = sigma_in*ones(size(Atoms)); % sigma of pseudocharge gaussian
